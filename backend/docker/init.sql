...
INSERT INTO `menus` VALUES (3, '2026-01-18 21:54:50', '2026-01-18 21:54:50', NULL, 'system2', '系统管理2', '/system2', '', NULL, 0, 'Setting', 101, 0, 0, NULL, 1);
...
INSERT INTO `menus` VALUES (14, '2026-01-18 21:54:50', '2026-01-18 21:54:50', NULL, 'operation-logs', '操作日志', '/operation-logs', 'OperationLogView', NULL, 2, 'Document', 4, 0, 0, NULL, 0);
...
INSERT INTO `menus` VALUES (25, '2026-01-18 21:54:50', '2026-01-18 21:54:50', NULL, 'permissions2', '权限管理2', '/permissions', 'PermissionManageView', NULL, 3, 'Lock', 5, 0, 0, NULL, 1);
...
-- ----------------------------
INSERT INTO `permission` VALUES (1, '', '', NULL, '/api/v1/users', 'GET', '', 1);
INSERT INTO `permission` VALUES (2, '', '', NULL, '/api/v1/users', 'POST', '测试', 1);
INSERT INTO `permission` VALUES (3, '', '', NULL, '/api/v1/users', 'DELETE', '', 1);
...
INSERT INTO `role_menus` VALUES (2, 25);
...
INSERT INTO `users` VALUES (10, '2026-01-18 19:07:49.000', '2026-01-20 10:04:26.130', NULL, 'admin', '$2a$10$ocZQAxtwX0K8aSywcLjICeMqyWv8KqvqJ7ZeoKSu9bMSIKjKhpkAq', 'admin2@example.com', '13800138009', '管理员', '', 1, '2026-01-20 15:01:14.985', '', 2);
